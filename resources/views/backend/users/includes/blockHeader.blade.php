<div class="block-header">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-10 col-sm-12 text-right">
            ...
            <a href="{{ route('export.data') }}" class="btn btn-sm btn-success btn-round" title="">Esporta Tutti Gli
                Utenti</a>
            <a href="{{ route('expired.data') }}" style="margin-right: 5px;" class="btn btn-sm btn-danger btn-round"
               title=""
